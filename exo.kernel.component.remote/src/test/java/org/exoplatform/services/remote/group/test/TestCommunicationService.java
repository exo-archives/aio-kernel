...
public class TestCommunicationService extends BasicTestCase {
  ...
  public void _testInitCommunicationService() throws Exception {
    ...
    ConfigurationManager manager = (ConfigurationManager) pcontainer.getComponentInstanceOfType(ConfigurationManager.class);
    Component component = manager.getComponent(CommunicationService.class);
    InitParams params = null;
    if (component != null)
      params = component.getInitParams();

    CommunicationServiceImpl service2 = (CommunicationServiceImpl) pcontainer.createComponent(CommunicationServiceImpl.class,
                                                                                              params);
    service2.addPlugin(new PingMessageHandler());
    service2.addPlugin(new GetCommunicationMonitorHandler());

    CommunicationServiceImpl service3 = (CommunicationServiceImpl) pcontainer.createComponent(CommunicationServiceImpl.class,
                                                                                              params);
