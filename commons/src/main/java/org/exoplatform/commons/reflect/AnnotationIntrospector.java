...
public class AnnotationIntrospector {
   ...
   */
  public static <A extends Annotation> A resolveClassAnnotations(Class<?> clazz, Class<A> classAnnotation) throws NullPointerException {
    if (clazz == null) {
  ...
  public static <A extends Annotation> Map<Method, A> resolveMethodAnnotations(Class<?> clazz, Class<A> methodAnnotation) {
    if (clazz == null) {
      throw new NullPointerException("No null class");
    }
