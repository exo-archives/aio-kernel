...
import org.exoplatform.services.remote.group.*;
import org.exoplatform.services.remote.group.impl.*;
...
public class TestCommunicationService extends BasicTestCase {
  ...
  public void testInitCommunicationService() throws Exception {
    ...
    CommunicationServiceImpl service1 = 
      (CommunicationServiceImpl)pcontainer.
    ...
    if(component != null) params = component.getInitParams() ;
