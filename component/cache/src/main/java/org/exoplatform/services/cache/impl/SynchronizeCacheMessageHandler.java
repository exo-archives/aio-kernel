 ...
 * @since Mar 5, 2005
 * @version $Id: SynchronizeCacheMessageHandler.java 5799 2006-05-28 17:55:42Z
 *          geaz $
 */
public class SynchronizeCacheMessageHandler extends MessageHandler {
  ...
  public Object handle(Message message) throws Exception {
    ...
    // ExoCache cache =
    // cacheService_.getCacheInstance(syncMessage.getCacheName()) ;
    cacheService_.synchronize(syncMessage.getCacheName(),
                              syncMessage.getCacheKey(),
                              syncMessage.getCacheValue());
    return null;
  }
}
