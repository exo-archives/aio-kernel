...
public class TestSchedulerService extends SchedulerServiceTestBase {
  ...
  public void testSeviceWithGlobalListener() throws Exception {
    ...
    assertTrue("The task is triggered  at the correct time  within 500ms margin",
               AJob.errorCounter_ == 0);
  ...
  public void testListener() throws Exception {
    ...
    hasObjectInCollection(globalTriggerListener,
                          triggerListenerCol,
                          new TriggerListenerComparator());
